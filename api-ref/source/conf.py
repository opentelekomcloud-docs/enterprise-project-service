...
otcdocs_repo_name = 'opentelekomcloud-docs/enterprise-project-service'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/enterprise-project-service/api-ref/'
otcdocs_doc_title = 'API Reference'
otcdocs_doc_type = 'api-ref'
otcdocs_service_category = 'security-services'
otcdocs_service_title = 'Enterprise Project Service'
otcdocs_service_type = 'eps'
...
html_title = "Enterprise Project Service - API Reference"
